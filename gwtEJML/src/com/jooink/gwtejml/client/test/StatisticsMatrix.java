...
public class StatisticsMatrix extends SimpleBase<StatisticsMatrix> {
	...
	static Logger lg=Logger.getLogger(StatisticsMatrix.class.getName());
    ...
    public static void init() {
        ...
        lg.log(Level.INFO, "Mean of A is               "+A.mean());
        // the mean should be about 1.5
        lg.log(Level.INFO, "Mean of B is               "+B.mean());

        StatisticsMatrix C = A.plus(B);

        // the mean should be about 2.0
        lg.log(Level.INFO, "Mean of C = A + B is       "+C.mean());

        lg.log(Level.INFO, "Standard deviation of A is "+A.stdev());
        lg.log(Level.INFO, "Standard deviation of B is "+B.stdev());
        lg.log(Level.INFO, "Standard deviation of C is "+C.stdev());
    }
}
