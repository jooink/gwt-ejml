...
public class ExampleFixedSizedMatrix {
	...
	static Logger lg=Logger.getLogger(ExampleFixedSizedMatrix.class.getName());
    public static void init() {
        ...
        lg.log(Level.INFO,"Determinant = "+FixedOps3.det(a));
        ...
        lg.log(Level.INFO,"Original simple matrix and converted fixed matrix");
        sv.print();
        fv.print();
    }
}
