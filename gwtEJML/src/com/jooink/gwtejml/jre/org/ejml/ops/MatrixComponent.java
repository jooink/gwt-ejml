...
public class MatrixComponent /*extends JPanel*/ {
    ...
    public MatrixComponent( int width , int height ) {
    	...
    	//
    	throw new UnsupportedOperationException("MatrixComponent: GWT-EJML does not support MatrixComponent");
    	//
...
//        repaint();
    ...
    public static void renderMatrix( D1Matrix64F M ,/* BufferedImage*/ Object image , double maxValue )
    {
