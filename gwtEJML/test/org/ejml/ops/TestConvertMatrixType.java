 ...
 * @author Peter Abeles
 */
public class TestConvertMatrixType   extends GWTEJMLTestCase {

    Random rand = new Random(234);

    @Test
    public void testany_to_any() {
    ...
    @Test
    public void testcheckAll_Fixed_to_DM() throws IllegalAccessException, InstantiationException, InvocationTargetException {
    ...
    @Test
    public void testcheckAll_DM_to_Fixed() throws IllegalAccessException, InstantiationException, InvocationTargetException {
        Method[] methods = ConvertMatrixType.class.getMethods();
