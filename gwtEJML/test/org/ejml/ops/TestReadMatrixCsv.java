 ...
 * @author Peter Abeles
 */
public class TestReadMatrixCsv  extends GWTEJMLTestCase  {
    /**
     * Make sure incorrectly formatted data is handled gracefully
     */
    @Test(expected=IOException.class)
    public void testbad_matrix_row() throws IOException {
        String s = "3 2 real\n0 0\n1 1";
    ...
    @Test(expected=IOException.class)
    public void testbad_matrix_col() throws IOException {
        String s = "3 2 real\n0 0\n1\n0 3";
